...
class ViewController: UIViewController {
    override func viewDidLoad() {
        ...
        let FFA409 = UIColor(red: 255/255.0, green: 164/255.0, blue: 9/255.0, alpha: 1.0)
        ...
        if let _ZBdropDownViews = ZBdropDownViews {
            ...
            view.setImageWhen(normal: UIImage(named: "arrow_nor"), selected: UIImage(named: "arrow_sel"), disabled: UIImage(named: "arrow_dim"), alwaysSelected: nil)
            view.setLabelColorWhen(normal: .black, selected: FFA409, disabled: .gray, alwaysSelected: nil)
